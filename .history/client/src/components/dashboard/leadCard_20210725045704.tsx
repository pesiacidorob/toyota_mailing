      ...
      <CardContent className={classes.card}>
        <Grid item container xs={12} md={12} >
            ...
            <Grid item container xs={6}>
                {props.data.map((item, index) => (<Grid item container xs={12} key={index} className={classes.bg}>
                      <Grid item xs={8}>
                        <Typography className={classes.contentR} display="inline">{item.name}</Typography>
                      </Grid>
                      <Grid item xs={4}>
                        <Typography className={classes.contentR}>{item.value}</Typography>
                      </Grid>
                    </Grid>
                ))} 
            </Grid>
