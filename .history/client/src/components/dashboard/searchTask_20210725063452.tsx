...
const IconButtonData = [
    { icon: <FcCalendar style={{ fontSize: 40, width: 50 }} />, label: 'Calendar' },
    { icon: <FcCollaboration style={{ fontSize: 40, width: 50 }} />, label: 'Team Chat' },
    { icon: <FcDecision style={{ fontSize: 40, width: 50 }} />, label: 'Queries' },
    { icon: <FcContacts style={{ fontSize: 40, width: 50 }} />, label: 'Contacts' },
    { icon: <FcEditImage style={{ fontSize: 40, width: 50 }} />, label: 'Build' },
    { icon: <FcList style={{ fontSize: 40, width: 50 }} />, label: 'Inventory' },
    { icon: <FcBullish style={{ fontSize: 40, width: 50 }} />, label: 'Analytics' },
    { icon: <FcDepartment style={{ fontSize: 40, width: 50 }} />, label: 'Marketing' },
    { icon: <FcIphone style={{ fontSize: 40, width: 50 }} />, label: 'Intelligence' },
    { icon: <FcFaq style={{ fontSize: 40, width: 50 }} />, label: 'Web chat' },
    { icon: <FcSms style={{ fontSize: 40, width: 50 }} />, label: 'Email' },
    { icon: <FcTemplate style={{ fontSize: 40, width: 50 }} />, label: 'Templates' },
];
